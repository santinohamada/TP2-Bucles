# Tp2 - Bucles
 ...
 En este repositorio se encuentran los ejercicios resueltos del Tp2 - Bucles de JavaScript del instituto Rolling Code School
...
```sh
$ git clone https://github.com/santinohamada/TP2-Bucles.git
```
